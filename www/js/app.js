...
angular.module('starter', ['ionic', 'starter.controllers', 'starter.services'])
  ...
  .config(function ($stateProvider, $urlRouterProvider) {
    ...
    // setup an abstract state for the tabs directive
      ...
      .state('tab.bible', {// choose new or old testament
        url: '/bible',
        views: {
          'tab-bible': {
      ...
      .state('tab.books', {//a list of books from testament choice
        url: '/bible/:testament',
        views: {
          'tab-bible': {
      ...
      .state('tab.chapters', {// a list of chapters from book choice
        url: '/bible/:book',
        views: {
          'tab-bible': {
      ...
      .state('tab.text', {// text of chosen chapter
